...
%% ------ Block Settings-------- %%
block1_pick = [8 3 0.05 270];
block2_pick = [-0.1 9.20 0.05 270];
block3_pick = [-6.2 6.1 0.05 270];

block2_flip = [-0.1 8.7 0.04 350];
block4_flip1 = [4.73 4.57 0.033 350];
block4_flip2 = [4.73 4.73 0.074 350];
block4_flip3 = [4.7 4.7 0.090 350];
%% ------ Opening the Port -------- %%
...
% setProfileVelocity(port_num, PROTOCOL_VERSION, ADDR_PROFILE_VELOCITY, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE, DXL_PROFILE_VELOCITY);
...
moveIntialPos(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,1411)
pause(5);
...
%% ------ Moving Robot -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2074);
GRIPPER_ANGLE2 = checkGripperAngle(1078);

%% ------ FOLD BAG -------- %%
fold_bag(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,GRIPPER_ANGLE1,GRIPPER_ANGLE2)
...
function setProfileVelocity(port_num, PROTOCOL_VERSION, ADDR_PROFILE_VELOCITY, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE, DXL_PROFILE_VELOCITY)
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_BASE_SPIN, ADDR_PROFILE_VELOCITY, DXL_PROFILE_VELOCITY);
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_ROT_ONE, ADDR_PROFILE_VELOCITY, DXL_PROFILE_VELOCITY);
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_ROT_TWO, ADDR_PROFILE_VELOCITY, DXL_PROFILE_VELOCITY);
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_ROT_THREE, ADDR_PROFILE_VELOCITY, DXL_PROFILE_VELOCITY);
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_GRIPPER, ADDR_PROFILE_VELOCITY, DXL_PROFILE_VELOCITY);
...
function time = calculateTime(angle)

    speed = 10; %rev/minute 
    
    % convert angle to revs
    angle_rev = angle * 0.00277778;

    time_mins = angle_rev / speed; 

    % convert min to ms
    time = time_mins * 60 * 1000;
...
function move_intermediate_Pos(x_coord,y_coord,z,gamma, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,GRIPPER_ANGLE)
   ...
   pause(2);
   %moveGoalPos(GRIPPER_ANGLE, 3,5,0.05,gamma, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   moveIntialPos(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,GRIPPER_ANGLE)

end

function fold_bag(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,GRIPPER_ANGLE1,GRIPPER_ANGLE2)
    %2074 closed gripper
    %1078 open gripper
   
   % Move weight   
   
   start = [1710,-7,0,0.01,270];
   final = [1411,-7,5,0.05,270];
   
   moveGoalPos(1411,-7,0,0.04,270, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pick_place(start(1),start(2),start(3),start(4),start(5), final(1),final(2),final(3),final(4),final(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE);
   
   pause(2);
   
   % Pick First Corner
   start = [2074,6,3.5,0.01,270];
   final = [1411,-1,3.5,0.01,270];
   
   moveGoalPos(start(1),start(2),start(3),start(4),start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveGoalPos(start(1),start(2),start(3),start(4)+0.04,start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveGoalPos(final(1),final(2),final(3),final(4)+0.04,start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveGoalPos(final(1),final(2),final(3),final(4),final(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   ...
   % Second Fold
   start = [2074,2.5,7,0.007,270];
   final = [1411,-4,7,0.01,270];
   
   moveGoalPos(start(1),start(2),start(3),start(4),start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveGoalPos(start(1),start(2),start(3),start(4)+0.08,start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveGoalPos(final(1),final(2),final(3),final(4)+0.05,start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   ...
   start = [1710,-6,5,0.01,270];
   final = [1411,-7,-0.5,0.01,270];
   
   moveGoalPos(1411,start(2),start(3),start(4)+0.03,start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pick_place_v2(start(1),start(2),start(3),start(4),start(5), final(1),final(2),final(3),final(4),final(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE);
   
   pause(2);
   
   % Third Fold
   start = [2074,-1,6,0.007,270];
   intermediate = [2074,3,6,0.007,270]; 
   final = [1411,-6,6,0.007,270];
   
   moveGoalPos(start(1),start(2),start(3),start(4),start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveGoalPos(start(1),start(2),start(3),start(4)+0.1,start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);

   moveGoalPos(intermediate(1),intermediate(2),intermediate(3),intermediate(4)+0.1,intermediate(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
    
   moveGoalPos(final(1),final(2),final(3),final(4)+0.06,final(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2); 
   ...
   %  Fold Sqaure 
   start = [2074,-2.5,9,0.007,270];
   final = [2074,0,5,0.15,350];
   
   moveGoalPos(start(1),start(2),start(3),start(4),start(5), port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
   pause(2);
   
   moveIntialPos(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,2074)
   pause(3);
...
function pick_place_v2(GRIPPER_ANGLE1,x1_coord,y1_coord,z1,gamma1, GRIPPER_ANGLE2, x2_coord,y2_coord,z2,gamma2, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
    % Move to initial position and grab the block
    moveGoalPos(GRIPPER_ANGLE1,x1_coord,y1_coord,z1,gamma1, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
    pause(4);

    if y1_coord<7 && abs(x1_coord)<7
        move_intermediate_Pos(x1_coord,y1_coord,z1,gamma1, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,GRIPPER_ANGLE1)   
    else
        moveIntialPos(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN,DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE,GRIPPER_ANGLE1)    
    end
    pause(4);
...
function id_array = circle(x1,y1,z,r,angle,gamma)
    ...
    yvals = r*sin(theta)+y1; % Define y coordinates
