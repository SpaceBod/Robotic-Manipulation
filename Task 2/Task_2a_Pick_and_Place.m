...
% block1_pick     = [8 3 0.055 270];
% block2_pick     = [-0.1 9.20 0.055 270];
% block3_pick     = [-6.4 6.1 0.055  270];
block4_pick     = [0 6 0.055 270];
block5_pick     = [4 4 0.045 270];
block6_pick     = [0 9 0.045 270];

block1_flip     = [7 7 0.04 350];
block2_flip     = [-2 7 0.04 350];
block3_flip     = [-7 0 0.04 350];
% block4_flip     = [4.7 4.7 0.055 350];
% block5_flip     = [0 3.5 0.055 350];
% block6_flip     = [-4.5 0 0.055 350];
...
pick_place(GRIPPER_ANGLE1, block1_flip(1), block1_flip(2), block1_flip(3), block1_flip(4), ...
           GRIPPER_ANGLE2, block4_pick(1), block4_pick(2), block4_pick(3), block4_pick(4), ...
...
pick_place(GRIPPER_ANGLE1, block3_flip(1), block3_flip(2), block3_flip(3), block3_flip(4), ...
           GRIPPER_ANGLE2, block6_pick(1), block6_pick(2), block6_pick(3), block6_pick(4), ...
           port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, ...
           TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE);
