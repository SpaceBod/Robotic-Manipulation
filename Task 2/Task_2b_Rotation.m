...
%% ------  Flip First Block and Place on Five -------- %%
...
%% ------ Pick and Place First Block Back to Original Place  -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);

pick_place(GRIPPER_ANGLE1, block5_flip(1), block5_flip(2), block5_flip(3), block5_flip(4), ...
...
%% ------ Flip Second Block and Place on Five -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);
...
%% ------ Flip Second Block on Block Five Again -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);
...
%% ------ Pick and Place Second Block Back to Original Place  -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);

pick_place(GRIPPER_ANGLE1, block5_flip(1), block5_flip(2), block5_flip(3), block5_flip(4), ...
           GRIPPER_ANGLE2, block2_flip(1), block2_flip(2), block2_flip(3), block2_flip(4), ...
           port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, ...
           TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE);

pause(1);

%% ------ Move Third Block to Block 5 -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);

pick_place(GRIPPER_ANGLE1, block3_flip(1), block3_flip(2), block3_flip(3), block3_flip(4), ...
           GRIPPER_ANGLE2, block5_flip(1), block5_flip(2), block5_flip(3), block5_flip(4), ...
           port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, ...
           TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE);
pause(1);


%% ------ Flip Third Block on Block 5 -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);
...
%% ------ Place Third Block Back to Original Position -------- %%
GRIPPER_ANGLE1 = checkGripperAngle(2400);
GRIPPER_ANGLE2 = checkGripperAngle(1472);

pick_place(GRIPPER_ANGLE1, block5_flip(1), block5_flip(2), block5_flip(3), block5_flip(4), ...
           GRIPPER_ANGLE2, block3_flip(1), block3_flip(2), block3_flip(3), block3_flip(4), ...
           port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, ...
           TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE);
pause(1);
...
function pick_place(GRIPPER_ANGLE1,x1_coord,y1_coord,z1,gamma1, GRIPPER_ANGLE2, x2_coord,y2_coord,z2,gamma2, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, ADDR_PROFILE_VELOCITY,ADDR_PROFILE_ACCELERATION, TIME_DURATION, TIME_ACCEL, DXL_ID_BASE_SPIN, DXL_ID_GRIPPER, DXL_ID_ROT_ONE, DXL_ID_ROT_TWO, DXL_ID_ROT_THREE)
    ...
    if gamma2 ==270
        if y2_coord<9 && abs(x2_coord)<7
            move_intermediate_Pos(x2_coord,y2_coord,z2,gamma2, port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION,ADDR_PROFILE_VELOCITY, ...
